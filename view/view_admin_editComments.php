		...
		<div class="center">
			...
			<div class="content">
				...
				<form action="" method="post" class="my-form hundredPorsent" autocomplete="off" enctype="multipart/form-data">
					...
					<input type="text" name="date" id="date" class="datepicker" value="<?=date("d-m-Y H:i",$data["data"]["date"])?>">
					<script>
						$(function(){ 
					...
					<input type="text" name="namelname" id="namelname" value="<?=htmlentities($data["data"]["namelname"])?>" autocomplete="off">

					<label for="comment">Comment: <font color="RED">*</font></label>
					<input type="text" name="comment" id="comment" value="<?=htmlentities($data["data"]["comment"])?>" autocomplete="off" />
					...
					<input type="submit" name="edit_comments" id="submit" value="Submit"><br>
