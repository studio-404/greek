			...
			<div class="content">
				...
				<form action="" method="post" class="my-form hundredPorsent" autocomplete="off">
					...
					if($_GET['type']=="eventpage"){
						echo '<div class="from-header" style="color:#ef4836; text-transform:uppercase">Add event</div>';
					}else{
						echo '<div class="from-header" style="color:#ef4836; text-transform:uppercase">Add news</div>';
					}
					?>
					...
					?>
						<label for="event_booth">Booth №: </label>
						<input type="text" name="event_booth" id="event_booth" value="" autocomplete="off">

						<label for="event_venue">Venue: </label>
						<input type="text" name="event_venue" id="event_venue" value="" autocomplete="off">

						<label for="event_fee">Event place: </label>
						<input type="text" name="event_fee" id="event_fee" value="" autocomplete="off">

						<label for="event_website">Event Web page: </label>
						<input type="text" name="event_website" id="event_website" value="" autocomplete="off">
					<?php
					}
					?>
                    ...
                    <textarea name="short_description" class="tinyMce"></textarea>
					...
					?>                  
                    <textarea name="long_description" class="tinyMce"></textarea>

                    <label for="tags">Tags: ( comma seperated value ) </label>
					<input type="text" name="tags" id="tags" value="" autocomplete="off">
					
					<input type="submit" name="add_news" id="submit" value="Submit"><br>
				</form>
			</div>
		</div>
	</main>
